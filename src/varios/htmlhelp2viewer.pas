...
uses
  Classes, SysUtils, LResources, Forms, base_form_maestro, Controls, Graphics, Dialogs, ExtCtrls,
...
type
  ...
  THelpViewerForm = class(TFormMaestro)
    IHP: TIpHtmlPanel;
...
procedure THelpViewerForm.SpeedButton1Click(Sender: TObject);
begin
  Close;
end;
